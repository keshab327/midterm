...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http
	   ...
	   .authorizeRequests()
	   .antMatchers("/","/shop/**","/register/**","/shopRegister2/**","/image/saveImageDetails/**","/image/display/**","/image/imageDetails/**","/image/show/**","/admin/**","/image/display_tax/**","/confirm_add_user/**","/reject_shop_request/**","/delete_shop_request/**","/admin/products/**").permitAll()
